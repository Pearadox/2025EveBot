...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double STATION_HEIGHT = 7.20; //TODO
    ...
    public static final double kG = 0.4; // tuned according to wpilib docs; may need to lower
  ...
  public static final class ArmConstants {
    ...
    public static final double ARM_INTAKE_ROT = Units.degreesToRotations(-20.877); //  was 61 //-299 // -311
    ...
    // TODO: tune pid
    public static final double kG = 0.15; // 0.15
