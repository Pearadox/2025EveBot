...
public final class Constants {
  ...
  public static final class ArmConstants {
    ...
    public static final int ARM_KRAKEN_ID = -1;
    public static final int CURRENT_LIMIT = 50;

    public static final double ARM_INTAKE_ROT = -1;
    public static final double ARM_LEVEL_2_ROT = -1;
    public static final double ARM_LEVEL_3_ROT = -1;
    public static final double ARM_LEVEL_4_ROT = -1;
