...
public final class Constants {
  ...
  public static final class ElevatorConstants {
    ...
    public static final double LEVEL_THREE_HEIGHT = 1; // 15 //TODO
    public static final double LEVEL_FOUR_HEIGHT = 24; // 29.625; //TODO
  ...
  public static final class ArmConstants {
    ...
    public static final double ARM_LEVEL_4_ROT = Units.degreesToRotations(-209); //-170 //-180 //0155.94 //-161
    public static final double ARM_LEVEL_3_ROT = Units.degreesToRotations(-111); //was -78 //79.08 // -66
    ...
    public static final double kV = 0.3; // 0.1
    public static final double kA = 0.1;
    public static final double kP = 0.5; // 0.2[]\
    public static final double kI = 0.02; // 0.05
